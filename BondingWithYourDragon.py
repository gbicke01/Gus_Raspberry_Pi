# Establishes API that requests velocity data from Airtable and publishes it to Create 3 robot to control it
# Written by Sebastian Fernandez and Gus Bickert
import sys 
import rclpy
import requests
import json
